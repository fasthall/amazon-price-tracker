					...
					<div class="col-xs-12 col-sm-9">
						...
						<div class="row">
							<div class="col-xs-6 col-lg-4">
								...
								<p></p>
								<p>
									<a class="btn btn-default" href="http://www.amazon.com/"
										target="_blank" role="button">Go To Amazon &raquo;</a>
								</p>
							</div>
							<!--/.col-xs-6.col-lg-4-->
							<div class="col-xs-6 col-lg-4">
								...
								<p>
									<a class="btn btn-default"
										href="https://cloud.google.com/appengine/" target="_blank">Go
										To Appengine &raquo;</a>
								</p>
							</div>
							<!--/.col-xs-6.col-lg-4-->
						</div>
